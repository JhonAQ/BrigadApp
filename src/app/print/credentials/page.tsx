            ...
            return (
              ...
              >
                ...
                <div className="flex-1 flex flex-col items-center pt-3 pb-2 px-3 relative">
                  ...
                  <p className="text-[5.5px] text-slate-400 mt-1 font-mono tracking-widest relative z-10 w-full text-center truncate">
                    QR ID: {b.dni || b.id}
                  </p>
                  ...
                  <div className="w-full mt-auto relative z-10 space-y-1.5 text-center">
                    <div>
                      <p
                        className="text-[12px] font-black text-slate-900 leading-none uppercase truncate"
                        title={b.name}
                      >
                        {b.name}
                      </p>
                    ...
                    <div className="flex justify-between items-end border-t border-slate-200 pt-1.5 mt-1">
                      <div className="text-left w-1/2 pr-1 overflow-hidden">
                        <p className="text-[6px] text-slate-500 font-bold uppercase truncate">
                          Documento
                        </p>
                        <p
                          className="text-[8px] font-bold text-slate-800 font-mono tracking-wider truncate block w-full"
                          title={b.dni || b.id}
                        >
                          {b.dni || b.id}
                        </p>
