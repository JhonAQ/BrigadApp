...
const MOCK_RESULTS = [
  { id: 'u3', name: 'Sub-Brig. Marcos Díaz', role: 'Sub-Brigadier', status: 'OK' },
  { id: 'u4', name: 'Brig. Aula Sofia Ruiz', role: 'Brigadier de Aula', status: 'OK' },
         ...
         <AnimatePresence mode="wait">
            {isScanning ? (
                ...
                >
                     ...
                     <p className="text-xs font-bold text-indigo-600 mb-6 bg-indigo-50 inline-block px-3 py-1 rounded-full uppercase tracking-wide border border-indigo-100">{scannedUser.role}</p>
                     
                     <div className="grid grid-cols-2 gap-3 mb-6">
                        <div className="bg-slate-50 p-4 rounded-xl border border-slate-100">
                             <p className="text-[10px] text-slate-400 uppercase font-bold mb-1 tracking-wider">Hora</p>
                             <p className="font-bold text-slate-700 text-lg">{new Date().toLocaleTimeString([], {hour: '2-digit', minute:'2-digit'})}</p>
                        </div>
                         <div className="bg-slate-50 p-4 rounded-xl border border-slate-100">
                             <p className="text-[10px] text-slate-400 uppercase font-bold mb-1 tracking-wider">Estado</p>
