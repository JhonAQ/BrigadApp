    ...
    <>
      ...
      <aside className={cn(
        ...
        <div className='h-20 flex items-center px-6 border-b border-slate-800 gap-3'>
          ...
          <div>
            <h1 className='text-white font-bold text-lg leading-tight tracking-tight'>BrigadApp</h1>
            <p className='text-[10px] text-slate-500 font-medium uppercase tracking-wider'>Gestión Escolar</p>
          </div>
        </div>
             ...
             <div className='bg-slate-800/50 rounded-xl p-4 mb-8 border border-slate-700/50 ring-1 ring-inset ring-white/5'>
                <div className='flex items-center gap-3 mb-3'>
                    ...
                    <div className='flex-1 min-w-0'>
                        ...
                        <p className='text-[11px] text-indigo-400 font-medium uppercase tracking-wide truncate mt-0.5'>{user.role.replace('_', ' ')}</p>
                    </div>
                </div>
                <div className='h-1 w-full bg-slate-700 rounded-full overflow-hidden'>
                    <div className='h-full bg-indigo-500 w-3/4 rounded-full'></div>
                </div>
                <p className='text-[10px] text-slate-500 mt-2 text-right'>Sesión activa</p>
             </div>
             ...
             <nav className='space-y-1.5'>
               {filteredItems.map((item) => {
                 ...
                 return (
                   ...
                   >
                     <item.icon className={cn('w-5 h-5 transition-colors', isActive ? 'text-indigo-200' : 'text-slate-500 group-hover:text-slate-300')} />
